...
const createMockFormData = (baseData: {
  ...
  basicInfo: {
    ...
    bidRegistrationStartTime: baseData.coverDate - 7 * 24 * 60 * 60 * 1000,
    bidRegistrationEndTime: baseData.coverDate - 1 * 24 * 60 * 60 * 1000,
  },
  bidderInstructions: {
    bidSectionCount: 1,
